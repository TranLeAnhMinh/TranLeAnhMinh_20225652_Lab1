...
public class TestPolymorphism {
    public static void main(String[] args) {
        ...
        DigitalVideoDisc dvd = new DigitalVideoDisc(1,"Neu ngay ay","Nhac tre", 18.5f,"Minh Tran",97);
        ArrayList<Track> tracks = new ArrayList<Track>();
        tracks.add(new Track("chuc mung ban",3));
        tracks.add(new Track("toi yeu ban",4));
        CompactDisc cd = new CompactDisc(2,"mot minh anh noi dau","that tinh",25.5f,"Anh Minh",tracks);
        List<String> authors = new ArrayList<String>();
        authors.add(" Huy Le");
        authors.add("Minh Nghi");
